...
O código de recomendação espera um objeto 'bd' com métodos específicos.
Este adaptador fornece essa interface usando PostgreSQL.
"""
...
class BancoDadosAdapter:
    ...
    Uso:
        from ia.db_adapter import BancoDadosAdapter
        bd = BancoDadosAdapter()
        livros = bd.livros  # Dicionário {id: LivroObj}
    """
